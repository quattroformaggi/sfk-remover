...
> entering a wrong username continues playing the code, displaying all files (dir) in the folder where the .exe is situated, which does not correlate with the code :thinking:
